...
class UserCommentTestCase(TestCase):
    ...
    def test_update_other_users_comment_fail(self):
        other_user = User.objects.create_user(
            email="other@test.com", name="다른유저", nickname="other1", phone_number="01055554444", password="otherpass"
        )
        comment_by_other = Comment.objects.create(post=self.post, author=other_user, content="남이 쓴 댓글")
