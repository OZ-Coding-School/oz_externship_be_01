...
from apps.qna.urls.image_urls import urlpatterns as image_urlpatterns
from apps.qna.urls.question_urls import urlpatterns as question_urlpatterns

urlpatterns = admin_urlpatterns + answer_urlpatterns + question_urlpatterns + image_urlpatterns
