...
from .views.test_admin_view import (
    ...
    DeleteMiniTestDeploymentView, DeploymentListView, DeploymentDetailView, TestDeploymentCreateView,
)
...
urlpatterns = [
    ...
    path("api/v1/tests/validate-code-user/", TestValidateCodeUserView.as_view(), name="test-validate-code-user"),# 배포 내역 조회 (GET)
    path("api/v1/admin/test-deployments/<int:deployment_id>/", DeploymentDetailView.as_view(),
    ...
    # 배포 삭제 (DELETE)
    path("api/v1/admin/test-deployments/<int:deployment_id>/delete/", DeleteMiniTestDeploymentView.as_view(),
