...
class PermissionsStudent(models.Model):
    user = models.ForeignKey("User", on_delete=models.CASCADE, related_name="student_permissions")
...
class PermissionsTrainingAssistant(models.Model):
    user = models.ForeignKey("User", on_delete=models.CASCADE, related_name="ta_permissions")
