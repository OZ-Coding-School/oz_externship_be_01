...
def validate_uploaded_files(files, max_count: int, field_name: str, allowed_extensions=None, blocked_extensions=None,
                            max_size_mb=None):
        ...
        if max_size_mb is not None:
            ...
            if file.size > max_size_bytes:
                raise ValidationError({
                    field_name: [f"'{file.name}'의 크기는 {max_size_mb}MB를 초과할 수 없습니다."]
                })